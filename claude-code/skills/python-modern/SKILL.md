...
### 型安全性
- **any型の使用禁止**（詳細は `type-safety` スキル参照）
- strict型チェックモードの活用
...
### セキュリティ
- CodeGuardによるセキュリティチェック（`security-codeguard` スキル参照）
- 機密情報は環境変数で管理
- 入力値の厳格なバリデーション
...
- **[solid-clean-code](../solid-clean-code/SKILL.md)**: SOLID原則とクリーンコード
- **[type-safety](../type-safety/SKILL.md)**: 型安全性の確保
- **[testing](../testing/SKILL.md)**: テストファーストアプローチ
- **[security-codeguard](../security-codeguard/SKILL.md)**: セキュアコーディング
- **[technical-writing](../technical-writing/SKILL.md)**: ドキュメント作成
