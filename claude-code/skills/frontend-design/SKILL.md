...
description: フロントエンドデザイン - 高品質で独創的なフロントエンドUIを作成。Webコンポーネント、ページ、アプリケーション構築時に使用。汎用的なAI美学を避け、洗練された本番環境グレードのコードを生成。
---
...
- **nextjs-web-modern**: Next.js固有の最適化
- **mcp-shadcn**: shadcn/uiコンポーネントの活用
- **type-safety**: TypeScript型安全性
