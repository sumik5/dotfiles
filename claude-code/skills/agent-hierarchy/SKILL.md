...
description: Agent階層管理 - PO→Manager→Developer階層の必須使用。小規模修正以外は必ずこの順序で実行。並列実行でパフォーマンス最適化。
---
...
- **aramaki**: PO Agentの詳細な使い方
- **kusanagi**: Manager Agentの詳細な使い方
- **tachikoma**: Developer Agentの詳細な使い方
